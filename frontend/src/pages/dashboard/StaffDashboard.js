      ...
      <div className="card-body">
        {schedules.length === 0 ? (
          <div className="empty-state">
            ...
            <small className="text-muted">Jadwal akan muncul di sini ketika admin menambahkannya</small>
          </div>
        ) : (
          ...
          <form onSubmit={handleCreatePost}>
            ...
            <div className="mb-3">
              ...
              <input 
                ...
                className="form-control" 
              />
              <small className="text-muted">Format: JPG, PNG, GIF. Maksimal 2MB</small>
            </div>
        ...
        <div className="card-body">
          {posts.length === 0 ? (
            <div className="empty-state">
              ...
              <small className="text-muted">Buat pengumuman pertama Anda menggunakan form di atas</small>
            </div>
          ) : (
                    ...
                    <div className="comments-section mt-3">
                      ...
                      <div className="comments-list">
                        {post.comments.map(comment => (
                          <div key={comment.id} className="comment-item p-2 mb-2 rounded bg-light">
                            <div className="d-flex justify-content-between align-items-start">
